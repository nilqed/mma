...
;; this whole thing fails right now in allegro-v4.2 on hp, so
;; just do this
;; sparc version, for now
#-allegro-v4.2 (defvar *uniq-table* (make-hash-table :test 'car-cdr-eq))

;;HP version, for now
#+allegro-v4.2 (defvar *uniq-table* (make-hash-table :test 'eql))
