...
Int[(A_.+B_.*Cos[c_.+d_.*x_])/Sqrt[a_+b_.*Cos[c_.+d_.*x_]],x_Symbol] := Dist[B/b,Int[Sqrt[a+b*Cos[c+d*x]],x]] +
 Dist[(b*A-a*B)/b,Int[1/Sqrt[a+b*Cos[c+d*x]],x]] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[b*A-a*B]



Int[Sqrt[Cos[c_.+d_.*x_]]*(A_+B_.*Cos[c_.+d_.*x_])/(a_+b_.*Cos[c_.+d_.*x_]),x_Symbol] := Dist[B/b,Int[Sqrt[Cos[c+d*x]],x]] + 
 Dist[(b*A-a*B)/b,Int[Sqrt[Cos[c+d*x]]/(a+b*Cos[c+d*x]),x]] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[a^2-b^2] && NonzeroQ[b*A-a*B]
...
Int[(A_+B_.*Cos[c_.+d_.*x_])/(Sqrt[Cos[c_.+d_.*x_]]*(a_+b_.*Cos[c_.+d_.*x_])),x_Symbol] := B/b*Int[1/Sqrt[Cos[c+d*x]],x] + 
 (b*A-a*B)/b*Int[1/(Sqrt[Cos[c+d*x]]*(a+b*Cos[c+d*x])),x] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[a^2-b^2] && NonzeroQ[b*A-a*B]



Int[(A_+B_.*Cos[c_.+d_.*x_])/(Sqrt[Cos[c_.+d_.*x_]]*Sqrt[a_+b_.*Cos[c_.+d_.*x_]]),x_Symbol] := B*Int[(1+Cos[c+d*x])/(Sqrt[Cos[c+d*x]]*Sqrt[a+b*Cos[c+d*x]]),x] + 
 (A-B)*Int[1/(Sqrt[Cos[c+d*x]]*Sqrt[a+b*Cos[c+d*x]]),x] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[a^2-b^2] && NonzeroQ[A-B]



Int[Cos[c_.+d_.*x_]^m_*(A_+B_.*Cos[c_.+d_.*x_]),x_Symbol] := -A*Sin[c+d*x]*Cos[c+d*x]^(m+1)/(d*(m+1)) + 
 Dist[1/(m+1),Int[Cos[c+d*x]^(m+1)*(B*(m+1)+A*(m+2)*Cos[c+d*x]),x]] /;FreeQ[{c,d,A,B},x] && RationalQ[m] && m<-1



Int[Cos[c_.+d_.*x_]^m_*(A_+B_.*Cos[c_.+d_.*x_]),x_Symbol] := B*Sin[c+d*x]*Cos[c+d*x]^m/(d*(m+1)) + 
 Dist[1/(m+1),Int[Cos[c+d*x]^(m-1)*(B*m+A*(m+1)*Cos[c+d*x]),x]] /;FreeQ[{c,d,A,B},x] && RationalQ[m] && m>1
...
Int[(A_.+B_.*Cos[c_.+d_.*x_])*(a_+b_.*Cos[c_.+d_.*x_])^n_,x_Symbol] := (b*A-a*B)*Sin[c+d*x]*(a+b*Cos[c+d*x])^(n+1)/(d*(n+1)*(a^2-b^2)) +
 Dist[1/((n+1)*(a^2-b^2)),
 Int[Sim[(n+1)*(a*A-b*B)-(n+2)*(b*A-a*B)*Cos[c+d*x],x]*(a+b*Cos[c+d*x])^(n+1),x]] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[b*A-a*B] && NonzeroQ[a^2-b^2] && RationalQ[n] && n<-1/2 && n!=-1
...
Int[(A_.+B_.*Cos[c_.+d_.*x_])*(a_+b_.*Cos[c_.+d_.*x_])^n_,x_Symbol] := B*Sin[c+d*x]*(a+b*Cos[c+d*x])^n/(d*(n+1)) + 
 Dist[1/(n+1),Int[Sim[b*B*n+a*A*(n+1)+(a*B*n+b*A*(n+1))*Cos[c+d*x],x]*(a+b*Cos[c+d*x])^(n-1),x]] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[b*A-a*B] && NonzeroQ[a^2-b^2] && RationalQ[n] && n>=1/2



Int[Cos[c_.+d_.*x_]^m_*(A_+B_.*Cos[c_.+d_.*x_])*(a_+b_.*Cos[c_.+d_.*x_]),x_Symbol] := -a*A*Sin[c+d*x]*Cos[c+d*x]^(m+1)/(d*(m+1)) + 
 Dist[1/(m+1),Int[Cos[c+d*x]^(m+1)*((b*A+a*B)*(m+1)+(a*A*(m+2)+b*B*(m+1))*Cos[c+d*x]),x]] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[a^2-b^2] && NonzeroQ[b*A-a*B] && RationalQ[m] && m<-1



Int[Cos[c_.+d_.*x_]^m_.*(A_+B_.*Cos[c_.+d_.*x_])*(a_+b_.*Cos[c_.+d_.*x_]),x_Symbol] := b*B*Sin[c+d*x]*Cos[c+d*x]^(m+1)/(d*(m+2)) + 
 Dist[1/(m+2),Int[Cos[c+d*x]^m*Sim[a*A*(m+2)+b*B*(m+1)+(b*A+a*B)*(m+2)*Cos[c+d*x],x],x]] /;FreeQ[{a,b,c,d,A,B},x] && NonzeroQ[a^2-b^2] && NonzeroQ[b*A-a*B] && RationalQ[m] && m>=-1
